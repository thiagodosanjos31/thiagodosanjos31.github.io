...
class Bd{
	...
	pesquisar(despesa){
		...
		//valor
		if(despesa.valor != ''){
			despesasFiltradas = despesasFiltradas.filter(d => d.valor.match(despesa.valor))
		}
...
function cadastrarDespesa() {
	...
	let modalCabecalho = document.getElementById('exampleModalLabel')
	let modalDescricao = document.getElementById('descricaoModal')
	let modalBotao = document.getElementById('botaoModal')
	...
	if(despesa.validarDados()){
		bd.gravar(despesa)
			//dialog de sucesso	
		modalCabecalho.innerHTML = 'Registro inserido com sucesso'
		document.getElementById('modal_titulo_div').className = 'modal-header text-success'

		modalDescricao.innerHTML = 'Despesa cadastrada com sucesso'
		...
		modalCabecalho.innerHTML = 'Erro na gravação'
		...
		$('#modalRegistraDespesa').modal('show')
		//class="modal-header text-danger"
	}
